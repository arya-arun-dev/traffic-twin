...
**Traffic Twin** is a full-stack traffic simulation and visualization platform designed to model vehicle movement, path routing, driver behavior, and intervention experiments on real-world road networks. It supports both interactive browser execution and server-side headless experiments using the same deterministic TypeScript simulation implementation.
